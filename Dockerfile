...
RUN echo y | /usr/local/android-sdk-linux/tools/android update sdk --filter build-tools-22.0.1,build-tools-23.0.1,build-tools-23.0.2,build-tools-23.0.3,build-tools-21.1.2,build-tools-24.0.0,build-tools-24.0.1,build-tools-21.0.3,,android-21,android-22,android-15,android-23,android-24 --no-ui -a
